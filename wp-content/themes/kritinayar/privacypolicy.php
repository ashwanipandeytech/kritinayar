   ...
   <section id="explain13milli-seconds">
         ...
         PRIVACY POLICY 
            ...
            <div class="taxt-1 text-left mb-2">
               <div class="mb-1">
               <p>Your privacy is important to us. It is Kriti Nayar&rsquo;s policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, kritinayar.com and other sites we own and operate.</p>
...
<ul>
    ...
    <li>
        <p>third party service providers for the purpose of enabling them to provide their services, for example, IT service providers, data storage, hosting and server providers, advertisers, or analytics platforms</p>
    </li>
    <li>
    ...
    <li>
        <p>third parties, including agents or sub-contractors, who assist us in providing information, products, services, or direct marketing to you third parties to collect and process data</p>
    </li>
</ul>
<h3>&nbsp;</h3>
